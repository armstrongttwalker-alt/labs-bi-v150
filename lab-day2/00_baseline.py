...
the compute pipeline actually gets to stretch its legs. This is where we
...
def main():
    ...
    print("-" * 70)
    print("  * 'torch' uses optimized library matmul -- strong baseline.")
    print("  * 'triton' is the Day 1 kernel with default BLOCK sizes (64, 64, 32).")
    print("  * 'ratio' = triton / torch. 1.0 means we match the library.")
    ...
    print("measuring the GPU architecture and tuning to it.")
