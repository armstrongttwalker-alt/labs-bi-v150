#!/usr/bin/env python3
"""
test.py - Multi-turn conversation client with context management.

Usage: python test.py [--base-url URL] [--model NAME] [--max-tokens N] [--max-context N]

Features:
- Streaming output
- Token counting for CJK and English text
- Context limit handling with automatic message trimming
...
def build_parser():
    ...
    p.add_argument("--base-url", default="http://localhost:8000/v1",
                    help="vLLM service URL (default: http://localhost:8000/v1)")
